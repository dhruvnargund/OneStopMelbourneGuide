...
public class NationalGalleryOfVictoria extends AppCompatActivity implements MuseumClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_national_gallery_of_victoria);

        recyclerView = findViewById(R.id.recycler_view_all_museums_ngv_page);
        RelativeLayout directionsButton = findViewById(R.id.ngv_directions_button);
        museumsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.82250093685777, 144.96888488169313&mode=1"));
    ...
    public void onItemClickMuseum(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(NationalGalleryOfVictoria.this, AustralianCenterMovingImage.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(NationalGalleryOfVictoria.this, IanPotterCenter.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(NationalGalleryOfVictoria.this, OldMelbourneGaol.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(NationalGalleryOfVictoria.this, MelbourneMuseum.class);
                startActivity(intent);
                break;
            case 4:
                intent = new Intent(NationalGalleryOfVictoria.this, RoyalExhibitionBuilding.class);
                startActivity(intent);
                break;
            case 5:
                intent = new Intent(NationalGalleryOfVictoria.this, PollyWoodside.class);
                startActivity(intent);
                break;
            case 6:
                intent = new Intent(NationalGalleryOfVictoria.this, NationalSportsMuseum.class);
                startActivity(intent);
                break;
            case 7:
                intent = new Intent(NationalGalleryOfVictoria.this, ArtVoImmersiveArtGallery.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(NationalGalleryOfVictoria.this, Scienceworks.class);
                startActivity(intent);
                break;
        }
    }
