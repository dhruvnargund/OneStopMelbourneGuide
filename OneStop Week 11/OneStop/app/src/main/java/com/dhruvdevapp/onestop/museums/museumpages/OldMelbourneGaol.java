...
public class OldMelbourneGaol extends AppCompatActivity implements MuseumClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_old_melbourne_gaol);


        recyclerView = findViewById(R.id.recycler_view_all_museums_old_gaol_page);
        RelativeLayout directionsButton = findViewById(R.id.old_gaol_directions_button);
        museumsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.80769573321391, 144.96527416614273&mode=1"));
    ...
    public void onItemClickMuseum(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(OldMelbourneGaol.this, NationalGalleryOfVictoria.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(OldMelbourneGaol.this, AustralianCenterMovingImage.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(OldMelbourneGaol.this, IanPotterCenter.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(OldMelbourneGaol.this, MelbourneMuseum.class);
                startActivity(intent);
                break;
            case 4:
                intent = new Intent(OldMelbourneGaol.this, RoyalExhibitionBuilding.class);
                startActivity(intent);
                break;
            case 5:
                intent = new Intent(OldMelbourneGaol.this, PollyWoodside.class);
                startActivity(intent);
                break;
            case 6:
                intent = new Intent(OldMelbourneGaol.this, NationalSportsMuseum.class);
                startActivity(intent);
                break;
            case 7:
                intent = new Intent(OldMelbourneGaol.this, ArtVoImmersiveArtGallery.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(OldMelbourneGaol.this, Scienceworks.class);
                startActivity(intent);
                break;
        }
    }
