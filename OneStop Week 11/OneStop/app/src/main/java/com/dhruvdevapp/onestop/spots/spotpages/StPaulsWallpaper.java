...
public class StPaulsWallpaper extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_st_pauls_wallpaper);


        recyclerView = findViewById(R.id.recycler_view_all_spots_st_paul_page);
        RelativeLayout directionsButton = findViewById(R.id.st_paul_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.81641812707523, 144.96755817955113&mode=1"));
    ...
    public void onSpotClick(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(StPaulsWallpaper.this, FederationSquare.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(StPaulsWallpaper.this, EurekaTower.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(StPaulsWallpaper.this, QueenVictoriaMarket.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(StPaulsWallpaper.this, MelbourneAquarium.class);
                startActivity(intent);
                break;
            case 4:
                intent = new Intent(StPaulsWallpaper.this, CrownCasino.class);
                startActivity(intent);
                break;
            case 5:
                intent = new Intent(StPaulsWallpaper.this, ShrineRemembrance.class);
                startActivity(intent);
                break;
            case 6:
                intent = new Intent(StPaulsWallpaper.this, StPatrik.class);
                startActivity(intent);
                break;
            case 7:
                intent = new Intent(StPaulsWallpaper.this, Parliament.class);
                startActivity(intent);
                break;
            case 8:
                intent = new Intent(StPaulsWallpaper.this, MelbourneZoo.class);
                startActivity(intent);
                break;
            case 9:
                intent = new Intent(StPaulsWallpaper.this, LunaPark.class);
                startActivity(intent);
                break;
            case 10:
                intent = new Intent(StPaulsWallpaper.this, BlockArcade.class);
                startActivity(intent);
                break;
            case 11:
                intent = new Intent(StPaulsWallpaper.this, Docklands.class);
                startActivity(intent);
                break;
            case 12:
                intent = new Intent(StPaulsWallpaper.this, SouthBank.class);
                startActivity(intent);
                break;
            case 13:
                intent = new Intent(StPaulsWallpaper.this, FlindersRailway.class);
                startActivity(intent);
                break;
            case 14:
                intent = new Intent(StPaulsWallpaper.this, PuffingBilly.class);
                startActivity(intent);
                break;
            case 15:
                intent = new Intent(StPaulsWallpaper.this, MelbourneStar.class);
                startActivity(intent);
                break;
            case 16:
                intent = new Intent(StPaulsWallpaper.this, StateLibrary.class);
                startActivity(intent);
                break;
            case 17:
                intent = new Intent(StPaulsWallpaper.this, Chinatown.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(StPaulsWallpaper.this, HosierLane.class);
                startActivity(intent);
                break;
