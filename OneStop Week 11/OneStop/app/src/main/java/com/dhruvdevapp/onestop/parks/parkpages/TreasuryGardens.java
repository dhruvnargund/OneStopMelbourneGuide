...
public class TreasuryGardens extends AppCompatActivity implements ParksClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_treasury_gardens);

        recyclerView = findViewById(R.id.recycler_view_all_parks_treasury_page);
        RelativeLayout directionsButton = findViewById(R.id.treasury_directions_button);
        parksArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.81433281944411, 144.97645627261258&mode=1"));
    ...
    private void parksArrayMethod() {
        ...
        parkArrayList.add(new Park("Alexandra Gardens", "The Alexandra Gardens are located on the south bank of the Yarra River, opposite Federation Square. Alexandra Gardens are part of a larger group of parklands directly south-east of the city, between St. Kilda Road and the Yarra River.", 4f, R.drawable.fitzroy_wallpaper));
    ...
    public void onItemClickPark(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(TreasuryGardens.this, RoyalBotanicalGarden.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(TreasuryGardens.this, FitzroyGarden.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(TreasuryGardens.this, Flagstaffgarden.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(TreasuryGardens.this, CarltonGarden.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(TreasuryGardens.this, AlexandraGarden.class);
                startActivity(intent);
                break;
