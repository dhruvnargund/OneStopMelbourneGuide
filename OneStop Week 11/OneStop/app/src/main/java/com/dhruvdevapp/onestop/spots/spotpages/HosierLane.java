...
public class HosierLane extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hosier_lane);

        recyclerView = findViewById(R.id.recycler_view_all_spots_hosier_page);
        RelativeLayout directionsButton = findViewById(R.id.hosier_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.81575739997723, 144.96916950215498&mode=1"));
