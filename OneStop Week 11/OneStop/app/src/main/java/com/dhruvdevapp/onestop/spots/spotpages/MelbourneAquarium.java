...
public class MelbourneAquarium extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_melbourne_aquarium);

        recyclerView = findViewById(R.id.recycler_view_all_spots_aquarium_page);
        RelativeLayout directionsButton = findViewById(R.id.aquarium_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.81997364324746, 144.9583621675145&mode=1"));
