...
public class LunaPark extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout directionsButton = findViewById(R.id.luna_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.86710262001031, 144.97666642145302&mode=1"));
