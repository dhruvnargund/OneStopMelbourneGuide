...
public class RoyalExhibitionBuilding extends AppCompatActivity implements MuseumClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_royal_exhibition_building);

        recyclerView = findViewById(R.id.recycler_view_all_museums_royal_exhibition_page);
        RelativeLayout directionsButton = findViewById(R.id.royal_exhibition_directions_button);
        museumsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.804315469979066, 144.97165015395814&mode=1"));
    ...
    public void onItemClickMuseum(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(RoyalExhibitionBuilding.this, NationalGalleryOfVictoria.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(RoyalExhibitionBuilding.this, AustralianCenterMovingImage.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(RoyalExhibitionBuilding.this, IanPotterCenter.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(RoyalExhibitionBuilding.this, OldMelbourneGaol.class);
                startActivity(intent);
                break;
            case 4:
                intent = new Intent(RoyalExhibitionBuilding.this, MelbourneMuseum.class);
                startActivity(intent);
                break;
            case 5:
                intent = new Intent(RoyalExhibitionBuilding.this, PollyWoodside.class);
                startActivity(intent);
                break;
            case 6:
                intent = new Intent(RoyalExhibitionBuilding.this, NationalSportsMuseum.class);
                startActivity(intent);
                break;
            case 7:
                intent = new Intent(RoyalExhibitionBuilding.this, ArtVoImmersiveArtGallery.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(RoyalExhibitionBuilding.this, Scienceworks.class);
                startActivity(intent);
                break;
        }
    }
