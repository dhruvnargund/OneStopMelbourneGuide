...
public class MelbourneMuseum extends AppCompatActivity implements MuseumClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_melbourne_museum);
        recyclerView = findViewById(R.id.recycler_view_all_museums_melbourne_musem_page);

        RelativeLayout directionsButton = findViewById(R.id.melbourne_musem_directions_button);
        museumsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.80321362017615, 144.97173006940002&mode=1"));
    ...
    public void onItemClickMuseum(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(MelbourneMuseum.this, NationalGalleryOfVictoria.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(MelbourneMuseum.this, AustralianCenterMovingImage.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(MelbourneMuseum.this, IanPotterCenter.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(MelbourneMuseum.this, OldMelbourneGaol.class);
                startActivity(intent);
                break;
            case 4:
                intent = new Intent(MelbourneMuseum.this, RoyalExhibitionBuilding.class);
                startActivity(intent);
                break;
            case 5:
                intent = new Intent(MelbourneMuseum.this, PollyWoodside.class);
                startActivity(intent);
                break;
            case 6:
                intent = new Intent(MelbourneMuseum.this, NationalSportsMuseum.class);
                startActivity(intent);
                break;
            case 7:
                intent = new Intent(MelbourneMuseum.this, ArtVoImmersiveArtGallery.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(MelbourneMuseum.this, Scienceworks.class);
                startActivity(intent);
                break;
        }
    }
