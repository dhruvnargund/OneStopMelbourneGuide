...
public class Flagstaffgarden extends AppCompatActivity implements ParksClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flagstaffgarden);
        recyclerView = findViewById(R.id.recycler_view_all_parks_flagstaff_page);
        RelativeLayout directionsButton = findViewById(R.id.flagstaff_directions_button);
        parksArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.81038752357975, 144.95460570942618&mode=1"));
    ...
    public void onItemClickPark(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(Flagstaffgarden.this, RoyalBotanicalGarden.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(Flagstaffgarden.this, FitzroyGarden.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(Flagstaffgarden.this, CarltonGarden.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(Flagstaffgarden.this, TreasuryGardens.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(Flagstaffgarden.this, AlexandraGarden.class);
                startActivity(intent);
                break;
