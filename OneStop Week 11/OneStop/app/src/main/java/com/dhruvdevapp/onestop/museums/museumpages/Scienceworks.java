...
public class Scienceworks extends AppCompatActivity implements MuseumClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scienceworks);

        recyclerView = findViewById(R.id.recycler_view_all_museums_scienceworks_page);
        RelativeLayout directionsButton = findViewById(R.id.scienceworks_directions_button);
        museumsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.83150967996599, 144.8930720503768&mode=1"));
    ...
    private void museumsArrayMethod() {
        ...
        museumsArrayList.add(new Museums(R.drawable.nsm_wallpapaer, "National gallery of Victoria", "NGV displays a wide range of furniture, fashion, textile, modern and historic art.", 5f));
    ...
    public void onItemClickMuseum(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(Scienceworks.this, NationalGalleryOfVictoria.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(Scienceworks.this, AustralianCenterMovingImage.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(Scienceworks.this, IanPotterCenter.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(Scienceworks.this, OldMelbourneGaol.class);
                startActivity(intent);
                break;
            case 4:
                intent = new Intent(Scienceworks.this, MelbourneMuseum.class);
                startActivity(intent);
                break;
            case 5:
                intent = new Intent(Scienceworks.this, RoyalExhibitionBuilding.class);
                startActivity(intent);
                break;
            case 6:
                intent = new Intent(Scienceworks.this, PollyWoodside.class);
                startActivity(intent);
                break;
            case 7:
                intent = new Intent(Scienceworks.this, NationalSportsMuseum.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(Scienceworks.this, ArtVoImmersiveArtGallery.class);
                startActivity(intent);
                break;
        }
    }
