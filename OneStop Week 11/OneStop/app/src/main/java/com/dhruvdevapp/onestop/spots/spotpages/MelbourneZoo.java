...
public class MelbourneZoo extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_melbourne_zoo);

        recyclerView = findViewById(R.id.recycler_view_all_spots_zoo_page);
        RelativeLayout directionsButton = findViewById(R.id.zoo_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.783048614779055, 144.95141842485373&mode=1"));
    ...
    public void onSpotClick(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(MelbourneZoo.this, FederationSquare.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(MelbourneZoo.this, EurekaTower.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(MelbourneZoo.this, StPaulsWallpaper.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(MelbourneZoo.this, QueenVictoriaMarket.class);
                startActivity(intent);
                break;
            case 4:
                intent = new Intent(MelbourneZoo.this, MelbourneAquarium.class);
                startActivity(intent);
                break;
            case 5:
                intent = new Intent(MelbourneZoo.this, CrownCasino.class);
                startActivity(intent);
                break;
            case 6:
                intent = new Intent(MelbourneZoo.this, ShrineRemembrance.class);
                startActivity(intent);
                break;
            case 7:
                intent = new Intent(MelbourneZoo.this, StPatrik.class);
                startActivity(intent);
                break;
            case 8:
                intent = new Intent(MelbourneZoo.this, Parliament.class);
                startActivity(intent);
                break;
            case 9:
                intent = new Intent(MelbourneZoo.this, LunaPark.class);
                startActivity(intent);
                break;
            case 10:
                intent = new Intent(MelbourneZoo.this, BlockArcade.class);
                startActivity(intent);
                break;
            case 11:
                intent = new Intent(MelbourneZoo.this, Docklands.class);
                startActivity(intent);
                break;
            case 12:
                intent = new Intent(MelbourneZoo.this, SouthBank.class);
                startActivity(intent);
                break;
            case 13:
                intent = new Intent(MelbourneZoo.this, FlindersRailway.class);
                startActivity(intent);
                break;
            case 14:
                intent = new Intent(MelbourneZoo.this, PuffingBilly.class);
                startActivity(intent);
                break;
            case 15:
                intent = new Intent(MelbourneZoo.this, MelbourneStar.class);
                startActivity(intent);
                break;
            case 16:
                intent = new Intent(MelbourneZoo.this, StateLibrary.class);
                startActivity(intent);
                break;
            case 17:
                intent = new Intent(MelbourneZoo.this, Chinatown.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(MelbourneZoo.this, HosierLane.class);
                startActivity(intent);
                break;
