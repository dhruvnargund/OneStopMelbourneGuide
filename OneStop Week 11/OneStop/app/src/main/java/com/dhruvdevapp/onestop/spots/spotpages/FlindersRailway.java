...
public class FlindersRailway extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flinders_railway);

        recyclerView = findViewById(R.id.recycler_view_all_spots_flinders_page);
        RelativeLayout directionsButton = findViewById(R.id.flinders_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.81749073602815, 144.96684712919503&mode=1"));
