...
public class Parliament extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parliament);

        recyclerView = findViewById(R.id.recycler_view_all_spots_parliament_page);
        RelativeLayout directionsButton = findViewById(R.id.parliament_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.80966216467733, 144.97269945631268&mode=1"));
    ...
    public void onSpotClick(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(Parliament.this, FederationSquare.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(Parliament.this, EurekaTower.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(Parliament.this, StPaulsWallpaper.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(Parliament.this, QueenVictoriaMarket.class);
                startActivity(intent);
                break;
            case 4:
                intent = new Intent(Parliament.this, MelbourneAquarium.class);
                startActivity(intent);
                break;
            case 5:
                intent = new Intent(Parliament.this, CrownCasino.class);
                startActivity(intent);
                break;
            case 6:
                intent = new Intent(Parliament.this, ShrineRemembrance.class);
                startActivity(intent);
                break;
            case 7:
                intent = new Intent(Parliament.this, StPatrik.class);
                startActivity(intent);
                break;
            case 8:
                intent = new Intent(Parliament.this, MelbourneZoo.class);
                startActivity(intent);
                break;
            case 9:
                intent = new Intent(Parliament.this, LunaPark.class);
                startActivity(intent);
                break;
            case 10:
                intent = new Intent(Parliament.this, BlockArcade.class);
                startActivity(intent);
                break;
            case 11:
                intent = new Intent(Parliament.this, Docklands.class);
                startActivity(intent);
                break;
            case 12:
                intent = new Intent(Parliament.this, SouthBank.class);
                startActivity(intent);
                break;
            case 13:
                intent = new Intent(Parliament.this, FlindersRailway.class);
                startActivity(intent);
                break;
            case 14:
                intent = new Intent(Parliament.this, PuffingBilly.class);
                startActivity(intent);
                break;
            case 15:
                intent = new Intent(Parliament.this, MelbourneStar.class);
                startActivity(intent);
                break;
            case 16:
                intent = new Intent(Parliament.this, StateLibrary.class);
                startActivity(intent);
                break;
            case 17:
                intent = new Intent(Parliament.this, Chinatown.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(Parliament.this, HosierLane.class);
                startActivity(intent);
                break;
