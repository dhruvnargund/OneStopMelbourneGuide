...
public class MelbourneStar extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_melbourne_star);

        recyclerView = findViewById(R.id.recycler_view_all_spots_star_page);
        RelativeLayout directionsButton = findViewById(R.id.star_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.81085052625138, 144.93747970160942&mode=1"));
    ...
    public void onSpotClick(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(MelbourneStar.this, FederationSquare.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(MelbourneStar.this, EurekaTower.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(MelbourneStar.this, StPaulsWallpaper.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(MelbourneStar.this, QueenVictoriaMarket.class);
                startActivity(intent);
                break;
            case 4:
                intent = new Intent(MelbourneStar.this, MelbourneAquarium.class);
                startActivity(intent);
                break;
            case 5:
                intent = new Intent(MelbourneStar.this, CrownCasino.class);
                startActivity(intent);
                break;
            case 6:
                intent = new Intent(MelbourneStar.this, ShrineRemembrance.class);
                startActivity(intent);
                break;
            case 7:
                intent = new Intent(MelbourneStar.this, StPatrik.class);
                startActivity(intent);
                break;
            case 8:
                intent = new Intent(MelbourneStar.this, Parliament.class);
                startActivity(intent);
                break;
            case 9:
                intent = new Intent(MelbourneStar.this, MelbourneZoo.class);
                startActivity(intent);
                break;
            case 10:
                intent = new Intent(MelbourneStar.this, LunaPark.class);
                startActivity(intent);
                break;
            case 11:
                intent = new Intent(MelbourneStar.this, BlockArcade.class);
                startActivity(intent);
                break;
            case 12:
                intent = new Intent(MelbourneStar.this, Docklands.class);
                startActivity(intent);
                break;
            case 13:
                intent = new Intent(MelbourneStar.this, SouthBank.class);
                startActivity(intent);
                break;
            case 14:
                intent = new Intent(MelbourneStar.this, FlindersRailway.class);
                startActivity(intent);
                break;
            case 15:
                intent = new Intent(MelbourneStar.this, PuffingBilly.class);
                startActivity(intent);
                break;
            case 16:
                intent = new Intent(MelbourneStar.this, StateLibrary.class);
                startActivity(intent);
                break;
            case 17:
                intent = new Intent(MelbourneStar.this, Chinatown.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(MelbourneStar.this, HosierLane.class);
                startActivity(intent);
                break;
