...
public class FitzroyGarden extends AppCompatActivity implements ParksClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout directionsButton = findViewById(R.id.fitzroy_directions_button);
        parksArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.81322943793459, 144.97976754540164&mode=1"));
