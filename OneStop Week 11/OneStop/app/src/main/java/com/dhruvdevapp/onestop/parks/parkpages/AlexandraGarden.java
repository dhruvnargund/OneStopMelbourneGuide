...
public class AlexandraGarden extends AppCompatActivity implements ParksClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout directionsButton = findViewById(R.id.alex_directions_button);
        parksArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.81993295054641, 144.97214192240338&mode=1"));
