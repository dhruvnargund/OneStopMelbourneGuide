...
public class QueenVictoriaMarket extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_queen_victoria_market);

        recyclerView = findViewById(R.id.recycler_view_all_spots_queen_market_page);
        RelativeLayout directionsButton = findViewById(R.id.queen_market_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.806934923467, 144.95691366853407&mode=1"));
    ...
    public void onSpotClick(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(QueenVictoriaMarket.this, FederationSquare.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(QueenVictoriaMarket.this, EurekaTower.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(QueenVictoriaMarket.this, StPaulsWallpaper.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(QueenVictoriaMarket.this, MelbourneAquarium.class);
                startActivity(intent);
                break;
            case 4:
                intent = new Intent(QueenVictoriaMarket.this, CrownCasino.class);
                startActivity(intent);
                break;
            case 5:
                intent = new Intent(QueenVictoriaMarket.this, ShrineRemembrance.class);
                startActivity(intent);
                break;
            case 6:
                intent = new Intent(QueenVictoriaMarket.this, StPatrik.class);
                startActivity(intent);
                break;
            case 7:
                intent = new Intent(QueenVictoriaMarket.this, Parliament.class);
                startActivity(intent);
                break;
            case 8:
                intent = new Intent(QueenVictoriaMarket.this, MelbourneZoo.class);
                startActivity(intent);
                break;
            case 9:
                intent = new Intent(QueenVictoriaMarket.this, LunaPark.class);
                startActivity(intent);
                break;
            case 10:
                intent = new Intent(QueenVictoriaMarket.this, BlockArcade.class);
                startActivity(intent);
                break;
            case 11:
                intent = new Intent(QueenVictoriaMarket.this, Docklands.class);
                startActivity(intent);
                break;
            case 12:
                intent = new Intent(QueenVictoriaMarket.this, SouthBank.class);
                startActivity(intent);
                break;
            case 13:
                intent = new Intent(QueenVictoriaMarket.this, FlindersRailway.class);
                startActivity(intent);
                break;
            case 14:
                intent = new Intent(QueenVictoriaMarket.this, PuffingBilly.class);
                startActivity(intent);
                break;
            case 15:
                intent = new Intent(QueenVictoriaMarket.this, MelbourneStar.class);
                startActivity(intent);
                break;
            case 16:
                intent = new Intent(QueenVictoriaMarket.this, StateLibrary.class);
                startActivity(intent);
                break;
            case 17:
                intent = new Intent(QueenVictoriaMarket.this, Chinatown.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(QueenVictoriaMarket.this, HosierLane.class);
                startActivity(intent);
                break;
