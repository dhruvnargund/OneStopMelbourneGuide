...
public class BlockArcade extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arcades_and_laneways);

        recyclerView = findViewById(R.id.recycler_view_all_spots_a_and_l_page);
        RelativeLayout directionsButton = findViewById(R.id.a_and_l_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.8152519222361, 144.9644947717614&mode=1"));
