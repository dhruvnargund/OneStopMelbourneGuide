...
public class IanPotterCenter extends AppCompatActivity implements MuseumClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ian_potter_center);

        recyclerView = findViewById(R.id.recycler_view_all_museums_ian_potter_page);
        RelativeLayout directionsButton = findViewById(R.id.ian_potter_directions_button);
        museumsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.79746554854929, 144.96416039887637&mode=1"));
    ...
    public void onItemClickMuseum(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(IanPotterCenter.this, NationalGalleryOfVictoria.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(IanPotterCenter.this, AustralianCenterMovingImage.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(IanPotterCenter.this, OldMelbourneGaol.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(IanPotterCenter.this, MelbourneMuseum.class);
                startActivity(intent);
                break;
            case 4:
                intent = new Intent(IanPotterCenter.this, RoyalExhibitionBuilding.class);
                startActivity(intent);
                break;
            case 5:
                intent = new Intent(IanPotterCenter.this, PollyWoodside.class);
                startActivity(intent);
                break;
            case 6:
                intent = new Intent(IanPotterCenter.this, NationalSportsMuseum.class);
                startActivity(intent);
                break;
            case 7:
                intent = new Intent(IanPotterCenter.this, ArtVoImmersiveArtGallery.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(IanPotterCenter.this, Scienceworks.class);
                startActivity(intent);
                break;
        }
    }
