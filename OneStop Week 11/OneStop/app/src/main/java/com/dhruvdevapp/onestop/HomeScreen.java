...
public class HomeScreen extends AppCompatActivity implements TravelTipsClickInterface, ParksClickInterface, MuseumClickInterface, SpotsClickInterface, MostViewedClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton = findViewById(R.id.relative_layout_login_button);
        clickListnerLogin(loginButton);

    }

    private void clickListnerLogin(RelativeLayout loginButton) {
        loginButton.setOnClickListener(v -> startActivity(new Intent(HomeScreen.this, LoginActivity.class)));
    }


    private void clickListenerParks(TextView parksButton) {
        parksButton.setOnClickListener(v -> {
    ...
    private void clickListenerMuseums(TextView museumsButton) {
        museumsButton.setOnClickListener(v -> {
