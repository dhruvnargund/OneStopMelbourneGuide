...
public class NationalSportsMuseum extends AppCompatActivity implements MuseumClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_national_sports_museum);

        recyclerView = findViewById(R.id.recycler_view_all_museums_nsm_page);
        RelativeLayout directionsButton = findViewById(R.id.nsm_directions_button);
        museumsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.81896588394119, 144.9842712831738&mode=1"));
    ...
    public void onItemClickMuseum(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(NationalSportsMuseum.this, AustralianCenterMovingImage.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(NationalSportsMuseum.this, IanPotterCenter.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(NationalSportsMuseum.this, OldMelbourneGaol.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(NationalSportsMuseum.this, MelbourneMuseum.class);
                startActivity(intent);
                break;
            case 4:
                intent = new Intent(NationalSportsMuseum.this, RoyalExhibitionBuilding.class);
                startActivity(intent);
                break;
            case 5:
                intent = new Intent(NationalSportsMuseum.this, PollyWoodside.class);
                startActivity(intent);
                break;
            case 6:
                intent = new Intent(NationalSportsMuseum.this, ArtVoImmersiveArtGallery.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(NationalSportsMuseum.this, Scienceworks.class);
                startActivity(intent);
                break;
        }
    }
