...
public class CrownCasino extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crown_casino);

        recyclerView = findViewById(R.id.recycler_view_all_spots_crown_page);
        RelativeLayout directionsButton = findViewById(R.id.crown_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.82295316724197, 144.9581381455301&mode=1"));
