...
public class PuffingBilly extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puffing_billy);

        recyclerView = findViewById(R.id.recycler_view_all_spots);
        RelativeLayout directionsButton = findViewById(R.id.puffing_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.907328330044145, 145.35662684980045&mode=1"));
    ...
    public void onSpotClick(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(PuffingBilly.this, FederationSquare.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(PuffingBilly.this, EurekaTower.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(PuffingBilly.this, StPaulsWallpaper.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(PuffingBilly.this, QueenVictoriaMarket.class);
                startActivity(intent);
                break;
            case 4:
                intent = new Intent(PuffingBilly.this, MelbourneAquarium.class);
                startActivity(intent);
                break;
            case 5:
                intent = new Intent(PuffingBilly.this, CrownCasino.class);
                startActivity(intent);
                break;
            case 6:
                intent = new Intent(PuffingBilly.this, ShrineRemembrance.class);
                startActivity(intent);
                break;
            case 7:
                intent = new Intent(PuffingBilly.this, StPatrik.class);
                startActivity(intent);
                break;
            case 8:
                intent = new Intent(PuffingBilly.this, Parliament.class);
                startActivity(intent);
                break;
            case 9:
                intent = new Intent(PuffingBilly.this, MelbourneZoo.class);
                startActivity(intent);
                break;
            case 10:
                intent = new Intent(PuffingBilly.this, LunaPark.class);
                startActivity(intent);
                break;
            case 11:
                intent = new Intent(PuffingBilly.this, BlockArcade.class);
                startActivity(intent);
                break;
            case 12:
                intent = new Intent(PuffingBilly.this, Docklands.class);
                startActivity(intent);
                break;
            case 13:
                intent = new Intent(PuffingBilly.this, SouthBank.class);
                startActivity(intent);
                break;
            case 14:
                intent = new Intent(PuffingBilly.this, FlindersRailway.class);
                startActivity(intent);
                break;
            case 15:
                intent = new Intent(PuffingBilly.this, MelbourneStar.class);
                startActivity(intent);
                break;
            case 16:
                intent = new Intent(PuffingBilly.this, StateLibrary.class);
                startActivity(intent);
                break;
            case 17:
                intent = new Intent(PuffingBilly.this, Chinatown.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(PuffingBilly.this, HosierLane.class);
                startActivity(intent);
                break;
