...
public class ShrineRemembrance extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout directionsButton = findViewById(R.id.shrine_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.82990563539652, 144.973345995015&mode=1"));
