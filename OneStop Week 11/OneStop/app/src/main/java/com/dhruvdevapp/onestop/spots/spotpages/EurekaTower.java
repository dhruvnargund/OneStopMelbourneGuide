...
public class EurekaTower extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eureka_tower);

        recyclerView = findViewById(R.id.recycler_view_all_spots_eureka_page);
        RelativeLayout directionsButton = findViewById(R.id.eureka_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.82062156233437, 144.9645693677717&mode=1"));
