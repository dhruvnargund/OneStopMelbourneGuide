...
public class Chinatown extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_view_all_spots_chinatown_page);
        RelativeLayout directionsButton = findViewById(R.id.chinatown_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.81083907349475, 144.9686591910814&mode=1"));
