...
public class Docklands extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_docklands);

        recyclerView = findViewById(R.id.recycler_view_all_spots_docklands_page);
        RelativeLayout directionsButton = findViewById(R.id.docklands_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.81783957155724, 144.94655326126178&mode=1"));
