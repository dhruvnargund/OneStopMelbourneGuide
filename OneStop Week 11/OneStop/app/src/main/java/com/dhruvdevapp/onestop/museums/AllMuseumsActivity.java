...
import com.dhruvdevapp.onestop.museums.museumpages.ArtVoImmersiveArtGallery;
...
import com.dhruvdevapp.onestop.museums.museumpages.NationalSportsMuseum;
import com.dhruvdevapp.onestop.museums.museumpages.OldMelbourneGaol;
import com.dhruvdevapp.onestop.museums.museumpages.PollyWoodside;
import com.dhruvdevapp.onestop.museums.museumpages.RoyalExhibitionBuilding;
import com.dhruvdevapp.onestop.museums.museumpages.Scienceworks;

import java.util.ArrayList;

public class AllMuseumsActivity extends AppCompatActivity implements MuseumClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_view_all_museums);
        museumsArrayMethod();
    }
    ...
    public void onItemClickMuseum(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(AllMuseumsActivity.this, NationalGalleryOfVictoria.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(AllMuseumsActivity.this, AustralianCenterMovingImage.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(AllMuseumsActivity.this, IanPotterCenter.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(AllMuseumsActivity.this, OldMelbourneGaol.class);
                startActivity(intent);
                break;
            case 4:
                intent = new Intent(AllMuseumsActivity.this, MelbourneMuseum.class);
                startActivity(intent);
                break;
            case 5:
                intent = new Intent(AllMuseumsActivity.this, RoyalExhibitionBuilding.class);
                startActivity(intent);
                break;
            case 6:
                intent = new Intent(AllMuseumsActivity.this, PollyWoodside.class);
                startActivity(intent);
                break;
            case 7:
                intent = new Intent(AllMuseumsActivity.this, NationalSportsMuseum.class);
                startActivity(intent);
                break;
            case 8:
                intent = new Intent(AllMuseumsActivity.this, ArtVoImmersiveArtGallery.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(AllMuseumsActivity.this, Scienceworks.class);
                startActivity(intent);
                break;
        }
    }
