...
public class SouthBank extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_south_bank);

        recyclerView = findViewById(R.id.recycler_view_all_spots_southbank_page);
        RelativeLayout directionsButton = findViewById(R.id.southbank_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.819504339152, 144.96814763353586&mode=1"));
    ...
    public void onSpotClick(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(SouthBank.this, FederationSquare.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(SouthBank.this, EurekaTower.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(SouthBank.this, StPaulsWallpaper.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(SouthBank.this, QueenVictoriaMarket.class);
                startActivity(intent);
                break;
            case 4:
                intent = new Intent(SouthBank.this, MelbourneAquarium.class);
                startActivity(intent);
                break;
            case 5:
                intent = new Intent(SouthBank.this, CrownCasino.class);
                startActivity(intent);
                break;
            case 6:
                intent = new Intent(SouthBank.this, ShrineRemembrance.class);
                startActivity(intent);
                break;
            case 7:
                intent = new Intent(SouthBank.this, StPatrik.class);
                startActivity(intent);
                break;
            case 8:
                intent = new Intent(SouthBank.this, Parliament.class);
                startActivity(intent);
                break;
            case 9:
                intent = new Intent(SouthBank.this, MelbourneZoo.class);
                startActivity(intent);
                break;
            case 10:
                intent = new Intent(SouthBank.this, LunaPark.class);
                startActivity(intent);
                break;
            case 11:
                intent = new Intent(SouthBank.this, BlockArcade.class);
                startActivity(intent);
                break;
            case 12:
                intent = new Intent(SouthBank.this, Docklands.class);
                startActivity(intent);
                break;
            case 13:
                intent = new Intent(SouthBank.this, FlindersRailway.class);
                startActivity(intent);
                break;
            case 14:
                intent = new Intent(SouthBank.this, PuffingBilly.class);
                startActivity(intent);
                break;
            case 15:
                intent = new Intent(SouthBank.this, MelbourneStar.class);
                startActivity(intent);
                break;
            case 16:
                intent = new Intent(SouthBank.this, StateLibrary.class);
                startActivity(intent);
                break;
            case 17:
                intent = new Intent(SouthBank.this, Chinatown.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(SouthBank.this, HosierLane.class);
                startActivity(intent);
                break;
