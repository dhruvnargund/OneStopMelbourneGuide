...
public class StateLibrary extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_state_library);

        recyclerView = findViewById(R.id.recycler_view_all_spots);
        RelativeLayout directionsButton = findViewById(R.id.library_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.80926556234956, 144.96527546510168&mode=1"));
    ...
    public void onSpotClick(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(StateLibrary.this, FederationSquare.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(StateLibrary.this, EurekaTower.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(StateLibrary.this, StPaulsWallpaper.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(StateLibrary.this, QueenVictoriaMarket.class);
                startActivity(intent);
                break;
            case 4:
                intent = new Intent(StateLibrary.this, MelbourneAquarium.class);
                startActivity(intent);
                break;
            case 5:
                intent = new Intent(StateLibrary.this, CrownCasino.class);
                startActivity(intent);
                break;
            case 6:
                intent = new Intent(StateLibrary.this, ShrineRemembrance.class);
                startActivity(intent);
                break;
            case 7:
                intent = new Intent(StateLibrary.this, StPatrik.class);
                startActivity(intent);
                break;
            case 8:
                intent = new Intent(StateLibrary.this, Parliament.class);
                startActivity(intent);
                break;
            case 9:
                intent = new Intent(StateLibrary.this, MelbourneZoo.class);
                startActivity(intent);
                break;
            case 10:
                intent = new Intent(StateLibrary.this, LunaPark.class);
                startActivity(intent);
                break;
            case 11:
                intent = new Intent(StateLibrary.this, BlockArcade.class);
                startActivity(intent);
                break;
            case 12:
                intent = new Intent(StateLibrary.this, Docklands.class);
                startActivity(intent);
                break;
            case 13:
                intent = new Intent(StateLibrary.this, SouthBank.class);
                startActivity(intent);
                break;
            case 14:
                intent = new Intent(StateLibrary.this, FlindersRailway.class);
                startActivity(intent);
                break;
            case 15:
                intent = new Intent(StateLibrary.this, PuffingBilly.class);
                startActivity(intent);
                break;
            case 16:
                intent = new Intent(StateLibrary.this, MelbourneStar.class);
                startActivity(intent);
                break;
            case 17:
                intent = new Intent(StateLibrary.this, Chinatown.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(StateLibrary.this, HosierLane.class);
                startActivity(intent);
                break;
