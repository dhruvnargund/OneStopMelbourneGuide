...
public class StPatrik extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_st_patrik);

        recyclerView = findViewById(R.id.recycler_view_all_spots_st_patrik_page);
        RelativeLayout directionsButton = findViewById(R.id.st_patrik_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.80984534321317, 144.97607334434682&mode=1"));
    ...
    public void onSpotClick(int position) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(StPatrik.this, FederationSquare.class);
                startActivity(intent);
                break;
            case 1:
                intent = new Intent(StPatrik.this, EurekaTower.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(StPatrik.this, StPaulsWallpaper.class);
                startActivity(intent);
                break;
            case 3:
                intent = new Intent(StPatrik.this, QueenVictoriaMarket.class);
                startActivity(intent);
                break;
            case 4:
                intent = new Intent(StPatrik.this, MelbourneAquarium.class);
                startActivity(intent);
                break;
            case 5:
                intent = new Intent(StPatrik.this, CrownCasino.class);
                startActivity(intent);
                break;
            case 6:
                intent = new Intent(StPatrik.this, ShrineRemembrance.class);
                startActivity(intent);
                break;
            case 7:
                intent = new Intent(StPatrik.this, Parliament.class);
                startActivity(intent);
                break;
            case 8:
                intent = new Intent(StPatrik.this, MelbourneZoo.class);
                startActivity(intent);
                break;
            case 9:
                intent = new Intent(StPatrik.this, LunaPark.class);
                startActivity(intent);
                break;
            case 10:
                intent = new Intent(StPatrik.this, BlockArcade.class);
                startActivity(intent);
                break;
            case 11:
                intent = new Intent(StPatrik.this, Docklands.class);
                startActivity(intent);
                break;
            case 12:
                intent = new Intent(StPatrik.this, SouthBank.class);
                startActivity(intent);
                break;
            case 13:
                intent = new Intent(StPatrik.this, FlindersRailway.class);
                startActivity(intent);
                break;
            case 14:
                intent = new Intent(StPatrik.this, PuffingBilly.class);
                startActivity(intent);
                break;
            case 15:
                intent = new Intent(StPatrik.this, MelbourneStar.class);
                startActivity(intent);
                break;
            case 16:
                intent = new Intent(StPatrik.this, StateLibrary.class);
                startActivity(intent);
                break;
            case 17:
                intent = new Intent(StPatrik.this, Chinatown.class);
                startActivity(intent);
                break;
            default:
                intent = new Intent(StPatrik.this, HosierLane.class);
                startActivity(intent);
                break;
