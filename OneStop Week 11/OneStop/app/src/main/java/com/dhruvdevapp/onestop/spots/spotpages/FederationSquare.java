...
public class FederationSquare extends AppCompatActivity implements SpotsClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_federation_square);


        recyclerView = findViewById(R.id.recycler_view_all_spots_federation_page);
        RelativeLayout directionsButton = findViewById(R.id.federation_directions_button);
        spotsArrayMethod();

        directionsButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=-37.81775199909318, 144.96903607440885&mode=1"));
