...
public class MuseumsAdapter extends RecyclerView.Adapter<MuseumsAdapter.MuseumViewHolder> {
    ...
    public MuseumsAdapter(ArrayList<MuseumItem> museumItemArrayList, MuseumClickInterface museumClickInterface) {
        ...
        public MuseumViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    museumClickInterface.onItemClickMuseum(getAdapterPosition());
                }
            });
        }
    }
